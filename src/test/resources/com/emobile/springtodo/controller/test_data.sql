...
VALUES (1, 'testuser', 'testuser@email.com', '$2a$10$JJ1sZDDlRuXJctwkWh493O7CE8HSQFvSmwo1G9t75Y7k.pAbsJFp.'),
(2,'user2', 'user2@email.com', '$2a$10$TJyBWsfXtWRHNyQNTHRhVewAulbjO7ZhQf8P6sNxbW9XirCufcaZG'),
(3, 'user3', 'user3@email.com', '$2a$10$nf5ui4aWO8FkMpdzXCrWIeCwdP5znPUKjENiCx9MF.am4m/jUxJwG');
/* passwords for users: testuser -> testpassword, user2 -> pass2, user3 -> pass3 */
ALTER SEQUENCE service_users_id_seq RESTART WITH 4;

INSERT INTO security_roles (id, user_id, security_role)
VALUES (1, 1, 'ROLE_ADMIN'), (2, 1, 'ROLE_USER'), (3, 3, 'ROLE_USER'), (4, 2, 'ROLE_USER');
ALTER SEQUENCE security_roles_id_seq RESTART WITH 5;
